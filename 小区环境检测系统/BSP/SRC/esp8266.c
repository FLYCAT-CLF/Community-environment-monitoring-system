...
void esp8266_send_bytes(uint8_t *buf)
{
...
int esp8266_init1(void)
{
	...
	if(rt)
	{
		printf("esp8266_exit_transparent_transmission fail1\r\n");
		return -1;
	}	
	printf("esp8266_exit_transparent_transmission success1\r\n");
	delay_ms(800);
	...
	if(rt)
	{
		printf("esp8266_reset fail1\r\n");
		return -2;
	}
	printf("esp8266_reset success1\r\n");
	delay_ms(500);
	...
	if(rt)
	{
		printf("esp8266_enable_echo(0) fail1\r\n");
		return -3;
	}	
	printf("esp8266_enable_echo(0)success1\r\n");
	delay_ms(500);
	...
	if(rt)
	{
		printf("esp8266_connect_ap fail1\r\n");
		return -4;
	}	
	printf("esp8266_connect_ap success1\r\n");
	delay_ms(500);
	
	rt =esp8266_connect_server("TCP",WEATHER_URL1,WEATHER_PORT);
	if(rt)
	{
		printf("esp8266_connect_server fail1\r\n");
		return -5;
	}	
	printf("esp8266_connect_server success1\r\n");
	delay_ms(500);
	...
	if(rt)
	{
		printf("esp8266_entry_transparent_transmission fail1\r\n");
		return -6;
	}	
	printf("esp8266_entry_transparent_transmission success1\r\n");
	delay_s(1);
